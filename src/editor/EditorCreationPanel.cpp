...
void EditorCreationPanel::Draw(EditorState& state, WorldManager& worldManager)
{
    ...
    const char* createKinds[] = { "Empty Object", "Cube", "Model From File", "Directional Light", "Point Light" };
    ...
    if (ImGui::Button("Create")) {
        ...
        if (state.createKind == 0) {
            ...
            state.selectedEntity = worldManager.CreateCube(
                name,
